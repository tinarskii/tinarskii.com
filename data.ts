...
export const education = [
    ...
    },
    {
        ...
        report : [
            { desc: "Semester 1", path: "~/assets/img/report/semester1.png" },
            { desc: "Semester 2", path: "~/assets/img/report/semester2.png" },
            { desc: "Semester 3", path: "~/assets/img/report/semester3.jpeg" },
        ],
    },
]
