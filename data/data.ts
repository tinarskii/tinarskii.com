...
export const contact = [
  ...
  "Discord",
  "tinyurl.com/tinarskii#9533",
  "Website",
  "tinarskii.com",
  "Blog (Hashnode)",
  "journey.tinarskii.com",
  "Email",
  "tinarskii@tinarskii.com",
  "Telephone",
  "+66984176673",
];
...
export const technology = {
  ...
  tools: ["Git", "OpenGPT", "GitHub Copilot"],
  misc: [
    "Microsoft Azure",
    "AWS",
    "Vercel",
...
export const interests = {
  subject: ["Computer Science", "Biology", "Sleeping", "Etymology"],
  games: [
    "Counter-Strike: Russian Offensive",
    "Neptunia Series",
    "Block Game (AKA Minecraft)",
    "Cunny Archive",
  ],
  music: ["The Beatles", "J-POP", "K-POP (Just kidding)"],
};
